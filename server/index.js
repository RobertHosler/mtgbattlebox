...
router.use(express.static(resolve(__dirname, '../client')));
...
import BattleboxSplitter from 'battlebox/Splitter';
...
var app = {
    ...
    publicDrafts: {},
    battlebox: {
        battleboxLands: _battleboxLands,
        battleboxes: _battleboxes,
    },
    cube: {
        cubes: _cubes
    },
